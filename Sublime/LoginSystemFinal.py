...
class Login_System:
	def __init__(self,root): # init is used to intialized something
		self.root = root #
		self.root.title("GAME SYSTEM | HARSH SINGH") # title is used to appear the things written in it.
		self.root.geometry("1350x700+0+0")

		self.phone_image=PhotoImage(file="images/1.png")
		...
		title=Label(login_frame,text="GAME LOGIN SYSTEM",font=("Elephant",20,"bold"),bg="white").place(x=0,y=30,relwidth=1)
		...
		btn_login=Button(login_frame,text="LOGIN",font=("Times New Roman",15),bg="#00B0F0",activebackground="#00B0F0",fg="white",activeforeground="white").place(x=50,y=300,width=250,height=35)
		...
		btn_signup=Button(register_frame,text="Sign up!",font=("time new roman",13,"bold"),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=200,y=17)
		...
		self.lbl_change_image.place(x=200,y=90,width=400,height=662)
